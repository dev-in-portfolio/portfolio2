...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "5817533f-8615-4753-886b-e1fc80bfbb64",
...
const _lazy__pACsb = () => import('../routes/api/cardpress/cards/_cardId_.delete.mjs');
const _lazy_oBiZJJ = () => import('../routes/api/cardpress/cards/_cardId_.patch.mjs');
const _lazy_w0vdFd = () => import('../routes/api/cardpress/pages/_id_.delete.mjs');
const _lazy_QMmxbY = () => import('../routes/api/cardpress/pages/_id_.get.mjs');
const _lazy_l3fG3n = () => import('../routes/api/cardpress/pages/_id_.patch.mjs');
const _lazy_N5ZBWx = () => import('../routes/api/cardpress/pages/_id/cards.post.mjs');
const _lazy_iAEjTC = () => import('../routes/api/cardpress/index.get.mjs');
const _lazy_IcBbJ4 = () => import('../routes/api/cardpress/index.post.mjs');
const _lazy_jqEa28 = () => import('../routes/api/cardpress/public/_publishedSlug_.get.mjs');
const _lazy_10ztqf = () => import('../routes/renderer.mjs').then(function (n) { return n.r; });

const handlers = [
  { route: '/api/cardpress/cards/:cardId', handler: _lazy__pACsb, lazy: true, middleware: false, method: "delete" },
  { route: '/api/cardpress/cards/:cardId', handler: _lazy_oBiZJJ, lazy: true, middleware: false, method: "patch" },
  { route: '/api/cardpress/pages/:id', handler: _lazy_w0vdFd, lazy: true, middleware: false, method: "delete" },
  { route: '/api/cardpress/pages/:id', handler: _lazy_QMmxbY, lazy: true, middleware: false, method: "get" },
  { route: '/api/cardpress/pages/:id', handler: _lazy_l3fG3n, lazy: true, middleware: false, method: "patch" },
  { route: '/api/cardpress/pages/:id/cards', handler: _lazy_N5ZBWx, lazy: true, middleware: false, method: "post" },
  { route: '/api/cardpress/pages', handler: _lazy_iAEjTC, lazy: true, middleware: false, method: "get" },
  { route: '/api/cardpress/pages', handler: _lazy_IcBbJ4, lazy: true, middleware: false, method: "post" },
  { route: '/api/cardpress/public/:publishedSlug', handler: _lazy_jqEa28, lazy: true, middleware: false, method: "get" },
  { route: '/__nuxt_error', handler: _lazy_10ztqf, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_island/**', handler: _SxA8c9, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_10ztqf, lazy: true, middleware: false, method: undefined }
];
