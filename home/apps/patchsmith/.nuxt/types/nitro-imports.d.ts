declare global {
  ...
  const getUserId: typeof import('../../server/utils/db').getUserId
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from '/root/portfolio3/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from '/root/portfolio3/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { pool, getUserId } from '/root/portfolio3/server/utils/db';